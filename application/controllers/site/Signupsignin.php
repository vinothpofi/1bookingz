     ...
     function create_normal_user($message)
    {
        ...
        if (valid_email($email)) {
            ...
            if ($duplicateMail->num_rows() > 0) {
				...
				$login_type='normal';
				$rep_code='';
				$this->user_model->insertUserQuick_user($firstname, $lastname, $phone_number, $email, $pwd, $confirm_password, $expireddate, $login_type, $this->input->post('birth_day'), $this->input->post('birth_month'), $this->input->post('birth_year'), $invite_reference, $rep_code,$acc_group_type,$business_name,$license_no,$business_addr);
