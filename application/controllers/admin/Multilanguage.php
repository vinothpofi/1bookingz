...
class Multilanguage extends MY_Controller
{
	...
	/**
	 *
	 * This function loads language list
	 */
	function index()
	{
	...
	/**
	 *
	 * This function edit language contents
	 */
	...
	function delete_multi_language_details()
	{
		//print_r($_POST);exit;
		$this->multilanguage_model->activeInactiveCommon(LANGUAGES_KNOWN, 'id');
	...
	/**
	 *
	 * This function sets language as default language
	 */
	...
	/**
	 *
	 * This function load user language list page
	 */
	...
	/**
	 *
	 * This function load edit user language form
	 */
	...
	/**
	 *
	 * This function loads add user language form
	 */
	...
	/**
	 *
	 * This function insert and edit user languages
	 */
	public function insertEditUserLang()
	{
		if ($this->checkLogin('A') == '') {
			...
			if ($language_id == '') {
				...
				$language_check = $this->multilanguage_model->get_all_details(LANGUAGES_KNOWN, array('language_name' => $this->input->post('language_name'),'id !=' => $language_id));

				if ($language_check->num_rows() > 0) {
					$this->setErrorMessage('error', 'This Language is Already Exists');
					redirect(ADMIN_PATH . '/multilanguage/edit_user_language/'.$language_id);
				} else {
	...
	/**
	 *
	 * This function delete user language
	 */
