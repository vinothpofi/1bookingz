...
<h1 style="font-size: 20px;">Hi <strong><?php echo $cus_name; ?></strong></h1>
<div>
<div>
<div style="margin-bottom: 10px; color: #484848; font-size: 16px;">The Host <strong><?php echo $host_name; ?></strong> is Accepted Your request to cancel your reservation.</div>
