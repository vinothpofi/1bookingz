...
<div class="p">
<div class="btn btn-primary space1"><a style="width: 300px; font-size: 22px; text-align: center; display: block; background-color: #752b7e; color: #fff; padding: 10px; margin: 20px 0; text-decoration: none;" href="<?php echo $cfmurl; ?>"> Confirm Email</a></div>
</div>
