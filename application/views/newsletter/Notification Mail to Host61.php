...
<h1 style="font-size: 20px;">Hi <?php echo $firstname; ?></h1>
<p style="margin-bottom: 10px; color: #484848; font-size: 16px;">We are excited to tell you that,<?php echo $product_title; ?>is booked now. To make your guest check-in seamless, we have suggest you to continue the conversation with the guest through HOMESTAYDNN internal messaging system to confirm their arrival time.</p>
