...
<div style="margin-bottom: 10px;">Welcome to <strong>HomeStayDNN</strong>!. Please confirm your email to get started.</div>
<div class="p ">
<div class="btn btn-primary space1" style="margin-bottom: 10px;"><strong>Email</strong> : <?php echo $email; ?>&nbsp;&nbsp;</div>
<div class="btn btn-primary space1" style="margin-bottom: 10px;"><strong>Username</strong> : <?php echo $username; ?>&nbsp;&nbsp;</div>
<div class="btn btn-primary space1" style="margin-bottom: 10px;"><strong>Password</strong> : <?php echo $password; ?>&nbsp;&nbsp;</div>
<div class="btn btn-primary space1" style="margin-bottom: 10px;"><strong>Rep Code </strong>: <?php echo $repcode; ?>&nbsp;&nbsp;</div>
</div>
