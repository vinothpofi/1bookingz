...
<h1 style="font-size: 20px;"><span>Hi <strong><?php echo $host_name; ?></strong></span><strong><label>,</label></strong></h1>
<div style="margin-bottom: 10px; color: #484848; font-size: 16px;">The Customer <strong><?php echo $cust_name; ?></strong> is Cancelled Your Experience Reservation.The Reason is we have mentioned below..</div>
<div class="p ">
<div class="btn btn-primary space1" style="margin-bottom: 10px; color: #484848; font-size: 16px;"><strong>Experience</strong>: <?php echo $prd_title; ?>&nbsp;&nbsp;</div>
