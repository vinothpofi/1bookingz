...
<p style="margin-bottom: 10px;">Have you forgetten your password? Don't worry. We already reset your password.</p>
</td>
</tr>
<tr>
<td width="50%" valign="top">
<p><strong>New Password :</strong> <?php echo $pwd; ?></p>
<p>You can login using above password and change your password immediately.</p>
<p>&nbsp;</p>
<p>Thanks,</p>
<div class="p "><span>Sent with&nbsp;</span><span>from <?php echo $email_title; ?> HQ</span></div>
<p>&nbsp;</p>
</td>
<td width="50%" valign="top">
<p>&nbsp;</p>
