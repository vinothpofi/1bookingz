        ...
        <div class="container inviteFrnds ">
            ...
            <?php ?>
                <div class="heading">
                    ...
                    <h5><?php if ($this->lang->line('Congratulation_host') != '') {
            echo stripslashes($this->lang->line('Congratulation_host'));
        } else { echo "Congratulation your property has been listed. Please pay further to book"; } ?></h5>
                </div>
