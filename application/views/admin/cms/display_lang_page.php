				...
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<div style="float: right;line-height:40px;padding:0px 10px;height:39px;">
							<?php if ($allPrev == '1' || in_array('2', $Pages)) 
							{ ?>
								<div class="btn_30_light" style="height: 29px;">
									<a href="javascript:void(0)"
									   onclick="return checkBoxValidationAdmin('Publish','<?php echo $subAdminMail; ?>');"
									   class="tipTop" title="Select any checkbox and click here to publish records"><span class="icon accept_co"></span><span class="btn_link">Publish</span></a>
								</div>

								<div class="btn_30_light" style="height: 29px;">
									<a href="javascript:void(0)"
									   onclick="return checkBoxValidationAdmin('Unpublish','<?php echo $subAdminMail; ?>');" class="tipTop"
					...
					<div class="widget_content">
						<table class="display display_tbl" id="cms_tbl">
							...
							<tr>
								...
								<th class="tip_top" title="Click to sort">Category</th>
								<th class="tip_top" title="Click to sort">Language</th>
							...
							if ($lang_detail->num_rows() > 0)
							{
								foreach ($lang_detail->result() as $row)
								{
									if ($row->lang_code != 'en')
									{
										$lang = $this->cms_model->get_all_details(LANGUAGES, array('lang_code' => $row->lang_code));
										?>
										<tr>
											...
											<td class="center">
												<a href="<?php echo base_url() . 'pages/' . $row->seourl; ?>"
												   target="_blank"><?php echo base_url() . 'pages/' . $row->seourl; ?></a>
											</td>
											<td class="center">
												...
												if ($allPrev == '1' || in_array('2', $Pages))
												{
													...
													if ($mode == 'No')
													{
														...
														<a title="Click to hide this page" class="tip_top"
														   href="javascript:confirm_mode('admin/cms/change_cms_mode/<?php echo $mode; ?>/<?php echo $row->id; ?>');"><span
																class="badge_style b_done"><?php echo $row->hidden_page; ?></span>
														</a>
														<?php
													} 
													else 
													{
														...
														<a title="Click to unhide this page" class="tip_top"
														   href="javascript:confirm_mode('admin/cms/change_cms_mode/<?php echo $mode; ?>/<?php echo $row->id; ?>')"><span
																class="badge_style"><?php echo $row->hidden_page; ?></span>
														</a>
														<?php
													}
												} 
												...
												if ($allPrev == '1' || in_array('2', $Pages))
												{
													...
													if ($mode == '0')
													{
														...
														<a title="Click to unpublish" class="tip_top"
														   href="javascript:confirm_status('admin/cms/change_cms_status/<?php echo $mode; ?>/<?php echo $row->id; ?>');"><span class="badge_style b_done"><?php echo $row->status; ?></span>
														</a>
														<?php
													} 
													else
