						...
						<ul>
							<li>
								<div class="form_grid_12">
									<?php
										...
										echo form_label('Experience Name','title', $commonclass);
									?>
							...
							<li>
								<div class="form_grid_12">
									...
									<div class="form_input">
										<?php if($review_details->row()->review_type == '0'){echo "Experience";}else{echo "Host";} ?>
									</div>
								</div>
							</li>
							...
							<li>
								<div class="form_grid_12">
									<div class="form_input">
										<a href="admin/experience_review/display_experience_review_list" class="tipLeft"
										   title="Go to review list"><span class="badge_style b_done">Back</span>
										</a>
									</div>
								</div>
							</li>
