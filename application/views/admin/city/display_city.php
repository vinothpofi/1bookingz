			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<?php
						if ($allPrev == '1' || in_array('1', $City))
						{
						?>
						
							<div class="btn_30_light" style="height: 29px;">
								<a href="admin/city/add_city_form" class="tipTop"
								   title="Click here to add List Value"><span class="icon add_co"></span><span class="btn_link">Add New</span>
								</a>
							</div>
							<?php 
						} ?>
											...
											if ($allPrev == '1' || in_array('2', $City))
											{
												...
												if ($mode == '0')
												{
													...
													<a title="Click to inactive" class="tip_top"
													   href="javascript:confirm_status('admin/city/change_city_status/<?php echo $mode; ?>/<?php echo $row->id; ?>/1');"><span
										...
										<td class="center">
											...
											{ ?>
												<span>
													<a class="action-icons c-edit"
														 href="admin/city/edit_city_form/<?php echo $row->id; ?>"
														 title="Edit">Edit
													</a>
												</span>
											<?php 
											...
											<span>
												<a class="action-icons c-suspend"
													 href="admin/city/view_city/<?php echo $row->id; ?>" title="View">View
												</a>
											</span>
											<?php 
											if ($allPrev == '1' || in_array('3', $City))
											{
												...
												<span>
													<a class="action-icons c-delete"
														 href="javascript:confirm_delete('admin/city/delete_city/<?php echo $row->id; ?>')"
														 title="Delete">Delete
													</a>
												</span>
											<?php 
