					...
					?>
	 						<ul>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <?php echo $city_details->row()->city;?>
									</div>
								</div>
								</li>
                                <li>
								...
								<div class="form_grid_12">
									<div class="form_input">
										<a href="admin/city/display_featured_cities" class="tipLeft" title="Go to location list"><span class="badge_style b_done">Back</span></a>
									</div>
								</div>
								</li>
							</ul>
