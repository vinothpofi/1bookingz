...
<noscript><link rel="stylesheet" href="<?php echo base_url(); ?>MultiImages/css/jquery.fileupload-ui-noscript.css"></noscript>
            ...
            <form id="fileupload" action="site/product/ul_photo" method="POST" enctype="multipart/form-data">
        <!-- Redirect browsers with JavaScript disabled to the origin page -->
        <noscript><input type="hidden" name="redirect" value="http://blueimp.github.io/jQuery-File-Upload/"></noscript>
        <!-- The fileupload-buttonbar contains buttons to add/delete files and start/cancel the upload -->
        <div class="row fileupload-buttonbar" >
            <div class="col-lg-7" style="width:789px !important;">
                ...
                <input type="checkbox" class="toggle"  style="width:50px !important;">
                
                <input type="submit" class="add_photos_btn" value="Add Photos"  />
        ...
        <table role="presentation" class="table table-striped" style="width:100% !important;"><tbody class="files"></tbody></table>
    </form>
   ...
   <!-- upload image script -->
   <div id="blueimp-gallery" class="blueimp-gallery blueimp-gallery-controls" data-filter=":even" style="width:100% !important;">
