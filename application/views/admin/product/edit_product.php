      ...
      <div class="widget_wrap">
        ...
        <div class="widget_content">
          ...
          <?php 
						...
						$attributes = array('class' => 'form_container left_label', 'id' => 'addproduct_form', 'enctype' => 'multipart/form-data','accept-charset'=>'UTF-8');
              ...
              <li>
                ...
                <div class="form_grid_12">
                  ...
                  <div class="form_input">
                    ...
                    <input name="product_name" id="product_name" value="<?php echo trim(stripslashes($product_details->row()->product_title));?>" type="text" tabindex="1" class="required large tipTop" title="Please enter the product name"  onchange = "check_product_exist()"/>
