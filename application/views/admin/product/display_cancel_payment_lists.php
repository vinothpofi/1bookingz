											...
											<td>
												...
												?>
													<span class="action_link">
														<a class="p_approve tipLeft" href="admin/product/add_pay_form/<?php echo $cancel->booking_no; ?>/<?php echo $cancel->id; ?>" title="Offline Payment Mode" style="margin-bottom:2px;">Offline</a>
													</span>

													<span class="action_link">
														<?php
														$attributes = array('onsubmit' => 'return checkHostPaypalEmail('.$i.')');
														echo form_open('admin/product/paypal_Cancelpayment_property', $attributes);
