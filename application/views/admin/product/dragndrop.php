...
function imageval(){   /*Image size validation*/
	...
	alert("Image Height and Width should be exactly 600 * 400 px.");
...
<div class="loading" style="display: none;"></div>
	...
	<div class="wrap">
		...
		<p>Please use an image that's at least 600px in width and 400px in height. Valid formats jpg, png, gif,jpeg..! </p>
		...
		<?php
			...
			$attributes = array('id' => 'ImgForm', 'enctype' => 'multipart/form-data');

			echo form_open('admin/product/InsertProductImage1', $attributes);
