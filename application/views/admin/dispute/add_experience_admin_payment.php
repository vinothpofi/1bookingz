		...
		<div class="grid_12">
			<div class="widget_wrap">
				...
				<div class="widget_content">
					...
					echo form_open_multipart('admin/dispute/add_exp_admin_payment_manual', $attributes)
					?>
					<ul>
						<?php
							echo form_input([
						...
						<li>
							...
							<div class="form_grid_12">
								<div class="form_input">
									...
									?>
									<a href="<?php echo base_url() . "admin/dispute/cancel_experience_booking_payment"; ?>">
