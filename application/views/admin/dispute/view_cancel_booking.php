					...
					<div class="widget_content">
						...
						<ul>
							...
							<li>
								<div class="form_grid_12">
									<?php
										echo form_label('Cancel Comments','description', $commonclass);	
									?>
									<div class="form_input">
							...
							<li>
								<div class="form_grid_12">
									<?php
										echo form_label('Cancel Email Address','description', $commonclass);	
									?>
									<div class="form_input">
                            ...
                            if(strtotime(date('Y-m-d')) < strtotime('Y-m-d',$checkin)) {
								    ...
								    ?>
										...
										<a href='<?php echo base_url() . "admin/dispute/Cancel_Book/" . $review_details->row()->id . '/' . $review_details->row()->booking_no . '/' . $review_details->row()->cancel_status; ?>'>
											<button type="button" class="btn_small btn_blue" tabindex="4"> <span>Accept</span></button>
										</a>

										<a href='<?php echo base_url() . "admin/dispute/rejectBooking/" . $review_details->row()->id . '/' . $review_details->row()->booking_no . '/' . $review_details->row()->cancel_status; ?>'>
								...
								<span class="badge_style" style="background-color: rgb(126, 123, 123);border-color:#771515"><?php echo $review_details->row()->status.'ed'; ?></span>
								<?php } ?>
                                </div>
                                </div>
                            </li>
						...
						<?php }
							...
							<li>
								<div class="form_grid_12">
									<div class="form_input">
										<a href="admin/dispute/cancel_booking_list" class="tipLeft" title="Go to Cancel Booking list"><span class="badge_style b_done">Back</span>
										</a>
									</div>
								</div>
							</li>
