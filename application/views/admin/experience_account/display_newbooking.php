			...
			<div class="grid_12">
				...
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						$payment = $this->experience_account_model->get_all_details(EXPERIENCE_BOOKING_PAYMENT,array('status'=>'Paid'));



						foreach($payment->result() as $enqId)

						{

							$enqIds[]=$enqId->EnquiryId;	
