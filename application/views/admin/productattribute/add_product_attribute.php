			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Add New Neighborhood Category</h6>
					...
					?>
						...
						<ul>
							...
							<div class="form_input">
								<input name="attr_name" id="attr_name" type="text" tabindex="1" class="required large tipTop" title="Please enter the Neighborhood Category"/>
							</div>
							</div>
							</li>
