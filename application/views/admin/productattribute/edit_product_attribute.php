			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Edit Neighborhood Category</h6>
					</div>
                ...
                <ul>
							...
							<label class="field_title" for="attribute_name">Neighborhood Category Name <span class="req">*</span></label>
							<div class="form_input">
								<input name="attr_name" id="attr_name" type="text" tabindex="1" class="required large tipTop" title="Please enter the Neighborhood Category" value="<?php echo $attribute_details->row()->attr_name;?>"/>
							</div>
							</div>
							</li>
