                ...
                <div class="widget_content">
                    <table class="display display_tbl" id="gift_tbl">
                        ...
                        <tr>
                            ...
                            <th class="tip_top" title="Click to sort">Code</th>
                            <th class="tip_top" title="Click to sort">Type</th>
                            <th class="tip_top" title="Click to sort">Value</th>
                            <th class="tip_top" title="Click to sort">Max.Used</th>
                            <th class="tip_top" title="Click to sort">Purchased</th>
                            <th class="tip_top" title="Click to sort">Remaining</th>
                            <th class="tip_top" title="Click to sort">Date From</th>
                            <th class="tip_top" title="Click to sort">Date To</th>
                            <th class="tip_top" title="Click to sort">Card Status</th>
                            <th class="tip_top" title="Click to sort">Coupon Type</th>
                            <th class="tip_top" title="Click to sort">Status</th>
                            <th>Action</th>
                        </tr>
                        </thead>
                        <?php
                        $paymentcoupon = $this->couponcards_model->get_all_details(COUPONCARDS, array());
                        ?>
                        <tbody>
                        <?php
                                        ...
                                        if ($allPrev == '1' || in_array('2', $Couponcode)) {
                                            ...
                                            if ($mode == '0') {
                                                ...
                                                <a title="Click to inactive" class="tip_top"
                                                   href="javascript:confirm_status('admin/couponcards/change_couponcard_status/<?php echo $mode; ?>/<?php echo $row->id; ?>');"><span
                                        ...
                                        <?php if ($allPrev == '1' || in_array('2', $Couponcode)) { ?>
                                            <span>
													<a class="action-icons c-edit"
                                                       href="admin/couponcards/edit_couponcard_form/<?php echo $row->id; ?>"
                                                       title="Edit">Edit
													</a>
												</span>
                                            <?php
                                        ...
                                        if ($allPrev == '1' || in_array('3', $Couponcode)) { ?>
                                            <span>
													<a class="action-icons c-delete"
                                                       href="javascript:confirm_delete('admin/couponcards/delete_couponcard/<?php echo $row->id; ?>')"
                                                       title="Delete">Delete
													</a>
												</span>
                                        <?php } ?>
