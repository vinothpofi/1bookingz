					...
					<div id="tab1">
	 						<ul>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<?php echo $user_details->row()->firstname;?>
									</div>
								</div>
								</li>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<?php echo $user_details->row()->lastname;?>
									</div>
								</div>
								</li>
                                <li>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <?php echo $user_details->row()->dob_month.'/'.$user_details->row()->dob_date.'/'.$user_details->row()->dob_year;?>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<?php  echo $user_details->row()->school; ?>
									</div>
								</div>
								</li>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<?php  echo $user_details->row()->work; ?>
									</div>
								</div>
								</li>
								<li>
