				...
				<div class="widget_wrap">
					...
					?>
						...
						<ul>
							...
							<li>
							<div class="form_grid_12">
							<label class="field_title" for="attribute_name">List Description <span class="req">*</span></label>
							<div class="form_input">
								<input name="attribute_description" id="attribute_description" type="text" tabindex="1" class="required large tipTop" title="Please enter the list description"/>
							</div>
							</div>
							</li>
