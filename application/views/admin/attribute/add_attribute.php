                         ...
                         <li>
							<!-- <div class="form_grid_12">
								<?php
									...
									echo form_label('Amenities Name (Arabic) <span class="req">*</span>','attribute_name_ar', $commonclass);	
								?>
								<div class="form_input">
									<?php
										...
										echo form_input([
									            ...
									            'tabindex' 	=> '1',
									            'class'     => 'tipTop required large',
									            'title'  	=> 'Please enter the amenities name in Arabic',
												'required'	=> 'required'
									        ]);

									?>
									<span id="attribute_name_ar_valid_error" style="color:#f00;display:none;">Only Alphabets are allowed!
									</span>
								</div>
							</div> -->
