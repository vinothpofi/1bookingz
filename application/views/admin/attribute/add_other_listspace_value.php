...
$.ajax(
     {
			type: 'POST',
			url:'<?php echo base_url(); ?>admin/listattribute/main_listspace_values',
			data:{'id':val1},
			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<?php 
						...
						echo form_open_multipart('admin/listattribute/insertEditListSpaceValue_other',$attributes) 
					?>
						...
						<ul>
							...
							<div class="form_grid_12">
								...
								<select name="toId" onchange="main_page(this.value)" >
									...
									<option value="<?php echo $page->id; ?>"><?php echo $page->list_value; ?></option>
									<?php } ?>
								</select>
								</div>
							</div>
							...
							<div class="form_input">
								<input name="list_description" id="list_description" type="text" tabindex="1" class="required large tipTop" title="Please enter the list value"/>
							</div>
							</div>
							</li>
