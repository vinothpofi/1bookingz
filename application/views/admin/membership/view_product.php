					...
					?>
                     ...
                     <div id="tab1">
						<ul>
							...
							<label class="field_title" for="name">Name </label>
                            ...
                            <li>
								<div class="form_grid_12">
								<label class="field_title" for="description">Valid</label>
								<div class="form_input">
								<?php 
								if ($product_details->row()->price != ''){
									echo $product_details->row()->valid_date;
								}else {
									echo 'Not available';
								}
								?>
                            ...
                            <li>
								...
								<div class="form_grid_12">
									<div class="form_input">
										<a href="admin/membership/display_membership" class="tipLeft" title="Go to membership list"><span class="badge_style b_done">Back</span></a>
									</div>
								</div>
								</li>
							</ul>
                     ...
                     <li>
                           ...
                           <li>
								<div class="form_grid_12">
									<div class="form_input">
										<a href="admin/fancyybox/display_fancyybox" class="tipLeft" title="Go to membership list"><span class="badge_style b_done">Back</span></a>
									</div>
								</div>
								</li>     
                      </ul>          
