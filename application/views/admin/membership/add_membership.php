						...
						<ul>
						  ...
						  <div class="form_input">
	 						...
	 						<li>
								...
								<div class="form_input">
								<textarea name="description" id="description" tabindex="2" style="width:370px;" class="large tipTop" title="Please enter the membership description"></textarea>
								</div>
								</div>
							</li>
                            ...
                            <div class="form_grid_12">
                              ...
                              <div class="form_input">
                                <input name="valid_date" id="valid_date" value="" type="text" tabindex="6" class="required small tipTop" title="Please enter the valid until date"/>
                              </div>
                            </div>
                          </li>
                            <li>
