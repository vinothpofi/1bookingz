                     ...
                     <div id="tab1">
						<ul>
							...
							<div class="form_input">
								<input name="name" id="name" value="<?php echo $product_details->row()->name;?>" type="text" tabindex="1" class="required large tipTop" title="Please enter the membership name"/>
							</div>
							</div>
							</li>
                        	...
                        	<li>
                            <div class="form_grid_12">
                              <label class="field_title" for="valid_date">Valid Until (Month) : <span class="req">*</span></label>
                              <div class="form_input">
                                <input name="valid_date" id="valid_date" value="<?php echo $product_details->row()->valid_date;?>" type="text" tabindex="6" class="required small tipTop" title="Please enter the valid until date"/>
                              </div>
                            </div>
                          </li>
	 						<li>
								...
								<div class="form_input">
								<textarea name="description" id="description" tabindex="2" style="width:370px;" class="required large tipTop" title="Please enter the membership description"><?php echo $product_details->row()->description;?></textarea>
								</div>
								</div>
							</li>
