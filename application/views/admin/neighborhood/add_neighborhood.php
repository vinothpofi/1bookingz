                    	...
                    	<div id="tab1">
	 						<ul>
								...
								<div class="form_grid_12">
									<label class="field_title" for="name">Neighborhood Name<span class="req">*</span></label>
                                ...
                                <li>
								<div class="form_grid_12">
									<label class="field_title" for="neighborhoods">City Name<span class="req">*</span></label>
									<div class="form_input">
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input id="tags_1" name="tags" type="text" class="tags" value=""/>
									</div>
								</div>
								</li>
                                ...
                                <li>
                                  <div class="form_grid_12">
                                    ...
                                    <div class="form_input">
                                      <textarea name="short_description" id="short_description" class="large tipTop" title="Please enter the short description"></textarea>
                                    </div>
                                  </div>
                                </li>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
                                        <select class="required chzn-select " name="category[]" multiple="multiple" tabindex="1" style="width: 375px;" data-placeholder="Please select the neighborhood category">
                                                <?php if($categoryArr->num_rows() > 0){foreach ($categoryArr->result() as $row){?>
                                                    <option value="<?php echo trim(stripslashes($row->attr_name));?>"><?php echo $row->attr_name;?></option>
                                                <?php }}?>
                                        </select>
                                    </div>
								</div>
