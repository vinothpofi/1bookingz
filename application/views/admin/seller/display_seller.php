						...
						<div style="float: right;line-height:40px;padding:0px 10px;height:39px;">
							...
							if ($allPrev == '1' || in_array('3', $seller)) 
							{
								...
								<div class="btn_30_light" style="height: 29px;">
									<a href="javascript:void(0)" onclick="return checkBoxValidationAdmin('Delete');"
					...
					<div class="widget_content">
						<table class="display display_tbl" id="seller_tbl">
							...
							<tr>
								...
								<th class="tip_top" title="Click to sort">Brand Name</th>
								<th class="tip_top" title="Click to sort">Description</th>
										...
										<td class="center">
											...
											if ($allPrev == '1' || in_array('2', $seller)) 
											{
												...
												<select name="seller_status"
														style="float: left;margin:10px 0 0 30%;width:100px;"
														id="seller_status_<?php echo $row->id; ?>">
												...
												<div class="btn_30_light" style="float:left;margin-left:10px;">
													<a href="javascript:changeSellerStatus('<?php echo $row->id; ?>','<?php echo $row->user_id; ?>')"
													   class="tipTop" title="Update Status"><span
															class="icon disk_co"></span></a>
												</div>
												<?php
											} else {
												?>
										...
										<td class="center">
											...
											<?php if ($allPrev == '1' || in_array('3', $seller)) { ?>
												<span><a class="action-icons c-delete"
														 href="javascript:confirm_delete('admin/seller/delete_seller/<?php echo $row->id; ?>')"
