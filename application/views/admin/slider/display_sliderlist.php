					...
					<div class="widget_content">
						<table class="display" id="newsletter_tbl">
							...
							<tr>
								...
								<th class="tip_top" title="Click to sort">Banner Name</th>
								<!-- <th class="tip_top" title="Click to sort">Banner Link</th> -->
								<th>Banner Image</th>
							...
							if ($sliderList->num_rows() > 0)
							{
								foreach ($sliderList->result() as $row)
								{
									?>
									<tr>
										<td class="center tr_select " style="display: none;">
											<?php
												echo form_input([
													'type'     => 'checkbox',
											        'value'    => $row->id,
										...
										<td class="center">
											<?php echo ucfirst($row->slider_name); ?>
										</td>
										<!-- <td class="center">
											...
											<div class="widget_thumb">
												...
												{ ?>
													<img class="rollovereff" width="40px" height="40px"
														 src="<?php echo base_url(); ?>images/slider/<?php echo $row->image; ?>"/>
												<?php 
												} 
												else 
												{ ?>
											...
											if ($allPrev == '1' || in_array('2', $Slider))
											{
												...
												if ($mode == '0')
												{
													...
													<a title="Click to inactive" class="tip_top"
													   href="javascript:confirm_status('admin/slider/change_slider_status/<?php echo $mode; ?>/<?php echo $row->id; ?>');"><span class="badge_style b_done"><?php echo $row->status; ?></span>
													</a>
													<?php
												} 
												else 
												{
													...
													<a title="Click to active" class="tip_top"
													   href="javascript:confirm_status('admin/slider/change_slider_status/<?php echo $mode; ?>/<?php echo $row->id; ?>')"><span class="badge_style"><?php echo $row->status; ?></span>
													</a>
													<?php
												}
											} 
										...
										<td class="center">
											...
											if ($allPrev == '1' || in_array('2', $Slider)) { ?>
												<span>
													<a class="action-icons c-edit"
														 href="admin/slider/edit_slider_form/<?php echo $row->id; ?>"
														 title="Edit">Edit
													</a>
												</span>
											<?php } ?>
											<span>
												<a class="action-icons c-suspend"
													 href="admin/slider/view_slider/<?php echo $row->id; ?>" title="View">View
													</a>
											</span>
											<?php if ($allPrev == '1' || in_array('3', $Slider)) { ?>
												<span style="display: none;">
													<a class="action-icons c-delete"
														 href="javascript:confirm_delete('admin/slider/delete_slider/<?php echo $row->id; ?>')" title="Delete">Delete
													</a>
												</span>
											<?php } ?>
										</td>
