	 						...
	 						<ul>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="email" id="email" type="text" tabindex="1" class="required large tipTop" title="Please enter the sub admin email address"/>
									</div>
								</div>
								</li>
								...
								<li>
								<div class="form_grid_12">
									<label class="field_title" for="admin_name">Name <span class="req">*</span></label>
									<div class="form_input">
										<input name="name" id="name" type="text" tabindex="2" class="required large tipTop" title="Please enter the sub admin username"/>
									</div>
								</div>
								</li>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="admin_name" id="admin_name" type="text" tabindex="2" class="required large tipTop" title="Please enter the sub admin username"/>
									</div>
								</div>
								</li>
								<li>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="confirm_password" id="confirm_password" type="password" tabindex="3" class="required large tipTop" title="Please enter the new password"/>
									</div>
								</div>
								</li>
