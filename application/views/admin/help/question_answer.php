					...
					<div class="widget_top">
						...
						<div style="float: right;line-height:40px;padding:0px 10px;height:39px;">
							<div class="btn_30_light" style="height: 29px; text-align:left;">
								<a href="admin/help/add_questionans_menu" class="tipTop"
								   title="Click here to add Question and Answer"><span
										class="icon add_co"></span><span class="btn_link">Add New</span>
								</a>
							</div>

							<div class="btn_30_light" style="height: 29px; text-align:left;">
								<a href="admin/help/add_lang_questionans" class="tipTop"
				...
				<div class="widget_content">
					<table class="display" id="currency_tbl">
						...
						<tr>
							...
							<th class="tip_top" title="Click to sort">Question</th>
						...
						if ($helpList->num_rows() > 0)
						{
							foreach ($helpList->result() as $row)
							{
								...
								<tr>
									...
									<td class="center">
										<a href="admin/help/display_other_question/<?php echo $row->id ?>">view</a>
									</td>
									<td class="center tr_select ">
										<?php
										if ($allPrev == '1' || in_array('2', $Help))
										{
											...
											if ($mode == '0')
											{
												...
												<a title="Click to inactive" class="tip_top"
												   href="javascript:confirm_status('admin/help/change_question_menu_status/<?php echo $mode; ?>/<?php echo $row->id; ?>');"><span class="badge_style b_done"><?php echo 'Active'; ?></span>
												</a>
												<?php
											} 
											else
											{
												...
												<a title="Click to active" class="tip_top"
												   href="javascript:confirm_status('admin/help/change_question_menu_status/<?php echo $mode; ?>/<?php echo $row->id; ?>')"><span class="badge_style"><?php echo 'Inactive'; ?></span>
												</a>
												<?php
											}
										} 
										...
										{ ?>
											<span>
												<a class="action-icons c-edit"
													 href="admin/help/edit_question_menu/<?php echo $row->id; ?>" title="Edit">Edit
												</a>
											</span>
										<?php 
										} 
										...
										{ ?>
											<span>
												<a class="action-icons c-delete"
													 href="javascript:confirm_delete('admin/help/delete_question_menu/<?php echo $row->id; ?>')" title="Delete">Delete
												</a>
											</span>
										<?php 
										} ?>
