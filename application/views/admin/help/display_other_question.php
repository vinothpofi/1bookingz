				...
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						<tr>
							...
							<th class="tip_top" title="Click to sort">Main Menu</th>
							<th class="tip_top" title="Click to sort">Sub Menu</th>
						...
						<tr>
							...
							if ($allPrev == '1' || in_array('2', $Listspace))
							{
								...
								{
							?>
								<a title="Click to inactive" class="tip_top" href="javascript:confirm_status('admin/help/change_question_menu_status/<?php echo $mode;?>/<?php echo $row->id;?>');"><span class="badge_style b_done"><?php echo 'Active';?></span>
								</a>
							<?php
								}else {	
							?>
								<a title="Click to active" class="tip_top" href="javascript:confirm_status('admin/help/change_question_menu_status/<?php echo $mode;?>/<?php echo $row->id;?>')"><span class="badge_style"><?php echo 'Inactive';?></span>
								</a>
							<?php 
								}
							}else {
