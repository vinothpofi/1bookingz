					...
					{ ?>
						<div style="float: right;line-height:40px;padding:0px 10px;height:39px;">
							<div class="btn_30_light" style="height: 29px; text-align:left;">
								<a href="admin/help/add_help_page" class="tipTop"
								   title="Click here to add Category page"><span class="icon add_co"></span><span class="btn_link">Add New</span>
								</a>
							</div>

							<div class="btn_30_light" style="height: 29px; text-align:left;">
								<a href="admin/help/add_lang_help" class="tipTop"
						...
						if ($mainmenu->num_rows() > 0)
						{
							foreach ($mainmenu->result() as $row)
							{
								...
								<tr>
									...
									<td class="center  tr_select">
										<?php if ($row->type == 'User') echo 'Guest'; else echo $row->type; ?>
									</td>
									<td class="center">
										<a href="admin/help/display_other_main/<?php echo $row->id ?>">view</a>
									</td>
									<td class="center tr_select ">
										<?php
										if ($allPrev == '1' || in_array('2', $Help))
										{
											...
											if ($mode == '0')
											{
												...
												<a title="Click to inactive" class="tip_top"
												   href="javascript:confirm_status('admin/help/change_main_menu_status/<?php echo $mode; ?>/<?php echo $row->id; ?>');"><span class="badge_style b_done"><?php echo 'Active'; ?></span>
												</a>
												<?php
											} 
											else
											{
												...
												<a title="Click to active" class="tip_top"
												   href="javascript:confirm_status('admin/help/change_main_menu_status/<?php echo $mode; ?>/<?php echo $row->id; ?>')"><span class="badge_style"><?php echo 'Inactive'; ?></span>
												</a>
												<?php
											}
										} 
										...
										{ ?>
											<span>
												<a class="action-icons c-edit"
													 href="admin/help/edit_helplist_form/<?php echo $row->id; ?>"
													 title="Edit">Edit
												</a>
											</span>
										<?php 
										...
										{ ?>
											<span>
												<a class="action-icons c-delete"
													 href="javascript:confirm_delete('admin/help/delete_help_list/<?php echo $row->id; ?>')"
													 title="Delete">Delete
												</a>
											</span>
										<?php } ?>
