							...
							<li>
								<div class="form_grid_12">
									...
									<div class="form_input">
										...
										echo form_dropdown('country_name', $ctrname, $currency_details->row()->country_name, $repattr);
									...
									<div class="form_input">
										<?php
											echo form_input([
									            ...
									            'maxlength'   => '5',
									            'id'          => 'currency_symbols',
												'value'	      => $currency_details->row()->currency_symbols,
												'tabindex'	  => '1',
												'class'		  => 'required tipTop',
									...
									<div class="form_input">
										<?php
											echo form_input([
									            ...
									            'maxlength'   => '5',
									            'id'          => 'currency_type',
												'value'	      => $currency_details->row()->currency_type,
												'tabindex'	  => '1',
												'class'		  => 'required tipTop',
												'title'		  => 'Please enter the currency type'
									        ]);
										
											$currtyp=array('id' => 'currency_type_len','style' => 'font-size:12px;display:none;','class' => 'error');
											echo form_label('Max 5 Characters Allowed','currency_symbols', $currtyp);	
										?>
										<span id="currency_type_valid" style="color:#f00;display:none;">Only Characters Allowed!
										</span>
										<br><br>
										<span style="font-size:14px; color:#CC3300;">*Note: Add the currency code accept by Paypal, to view the currency codes click the Below link,<br/><br/> 
											<a
												href="javascript: void(0)" onclick="window.open('https://developer.paypal.com/webapps/developer/docs/classic/api/currency_codes/ ', 'Paypal Currency Code', 'width=1200, height=1200');
							...
							<li>
								<div class="form_grid_12">
									<div class="form_input">
										...
										?>
										<a href="<?php echo base_url() . "admin/currency/display_currency_list"; ?>">
											<button type="button" class="btn_small btn_blue" tabindex="4"><span>Back</span></button>
										</a>
									</div>
								</div>
							</li>
