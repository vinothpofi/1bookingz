					...
					?> 		
                    	<div id="tab1">
	 						<ul>
								...
								<div class="form_grid_12">
									...
									<?php
										echo form_input([
												...
												'value'	    => $location_details->row()->name
									    ]);
								...
								<div class="form_grid_12">
									<?php
										echo form_label('Country Code <span class="req">*</span>','iso_code2', $commonclass);	
									?>
									<div class="form_input">
									<?php
										echo form_input([
												...
												'value'	    => $location_details->row()->country_code
									    ]);
									?>
									</div>
								</div>
								...
								<div class="form_grid_12">
									<?php
										echo form_label('Country Mobile Code <span class="req">*</span>','iso_code3', $commonclass);	
									?>
									<div class="form_input">
									<?php
										echo form_input([
												...
												'value'	    => $location_details->row()->country_mobile_code
									    ]);
									?>
									</div>
								</div>
								...
								<div class="form_grid_12">
									<?php
										echo form_label('Language <span class="req">*</span>','language_code', $commonclass);	
									?>
									<div class="form_input">
									<?php
										$lng=array();
										...
										echo form_dropdown('language_code', $lng, $location_details->row()->language_code, $lngattr);
								...
								<div class="form_grid_12">
									<div class="form_input">
										...
										?>										
										<a href="<?php echo base_url();?>admin/location/display_location_list" ><button class="btn_small btn_blue" type="button">Back</button>
										</a>
									</div>									
								</div>
								</li>
			                    ...
			                    <div class="form_input">
			                    	<?php
										echo form_input([
												...
												'value'	    => $location_details->row()->meta_title
									    ]);
									?>
			                    </div>
			                  </div>
			                    ...
			                    <div class="form_input">
			                    	<?php
			                    		$keywrdattr = array(
			                    			...
			                    			'value' 	=> $location_details->row()->meta_keywor
			                    		);
			                    ...
			                    <div class="form_input">
			                    	<?php
			                    		$descattr = array(
			                    			...
			                    			'value' 	=> $location_details->row()->meta_description
			                    		);
