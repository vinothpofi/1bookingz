											...
											<td>
												...
												?>
													<span class="action_link">
														<a class="p_approve tipLeft" href="admin/experience/add_pay_form/<?php echo $cancel->booking_no; ?>/<?php echo $cancel->id; ?>" title="Offline Payment Mode" style="margin-bottom:2px;">Offline</a>
													</span>
