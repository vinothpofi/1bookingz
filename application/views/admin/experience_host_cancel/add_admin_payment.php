		...
		<div class="grid_12">
			<div class="widget_wrap">
				...
				<div class="widget_content">
					...
					echo form_open_multipart('admin/experience/add_admin_payment_manual', $attributes)
					?>
					<ul>
						<?php
							echo form_input([
						...
						<li>
							...
							<div class="form_grid_12">
								<div class="form_input">
									...
									?>
									<a href="<?php echo base_url() . "admin/vehicle_dispute/cancel_booking_payment/". $vehicle_type; ?>">
