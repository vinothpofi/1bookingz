					...
					<div class="widget_top">
						...
						<div style="float: right;line-height:40px;padding:0px 10px;height:39px;">
							...
							if ($allPrev == '1' || in_array('3', $Review))
							{
								?>
								<div class="btn_30_light" style="height: 29px;">
									<a href="javascript:void(0)" onclick="return checkBoxValidationAdmin('Delete','<?php echo $subAdminMail; ?>');" class="tipTop" title="Select any checkbox and click here to delete records"><span
					...
					<div class="widget_content">
						<table class="display display_tbl" id="review_tbl">
							...
							if (count($reviewList->result_array()) > 0)
							{
								foreach ($reviewList->result_array() as $row)
								{
									...
									<tr>
										...
										<td class="center  tr_select">
											<?php if($row['review_type'] == '0'){echo "Rental";}else{echo "Host";} ?>
										</td>
                                        <td class="center tr_select ">
											...
											if ($allPrev == '1' || in_array('2', $Review))
											{
												...
												if ($mode == '0')
												{
													...
													<a title="Click to inactive" class="tip_top"
													   href="javascript:confirm_status('admin/review/change_review_status/<?php echo $mode; ?>/<?php echo $row['id']; ?>');"><span class="badge_style b_done"><?php echo $row['status']; ?></span>
													</a>
													<?php
												}
												else
												{
													...
													<a title="Click to active" class="tip_top"
													   href="javascript:confirm_status('admin/review/change_review_status/<?php echo $mode; ?>/<?php echo $row['id']; ?>')"><span class="badge_style"><?php echo $row['status']; ?></span>
													</a>
													<?php
												}
											} 
										...
										<td class="center">
											<span>
												<a class="action-icons c-suspend"
													 href="admin/review/view_review/<?php echo $row['id']; ?>"
													 title="View">View
												</a>
											</span>
											<?php 
											...
											{ ?>
												<span>
													<a class="action-icons c-delete"
														 href="javascript:confirm_delete('admin/review/delete_review/<?php echo $row['id']; ?>')" title="Delete">Delete
													</a>
												</span><?php 
											} ?>
										</td>
							...
							<tr>
								...
								<th><span class="center">Email</span></th>
								<th>Date added</th>
								<th>Status</th>
								<th>Action</th>
							</tr>
