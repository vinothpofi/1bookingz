...
Class Facebook
{
    ...
    public function __construct(){
       ...
       // echo '<br>facebook_auth_on_load'.$this->config->item('facebook_auth_on_load');
    ...
    private function authenticate(){
        ...
        if(!$access_token){
            try{
               // echo '<br>get helper access token'.'<br>';
                $helper = $this->fb->getRedirectLoginHelper();

                $accessToken = $helper->getAccessToken();
                //echo '<br>Try access token'.$accessToken.'<br>';
    ...
    private function get_access_token(){
       // echo 'session'.$_SESSION['fb_access_token'].'|'.$this->session->userdata('fb_access_token');
    ...
    private function set_access_token(AccessToken $access_token){
        ...
        //$_SESSION['fb_access_token']=$access_token->getValue();
