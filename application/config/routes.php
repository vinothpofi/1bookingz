...
$route['login'] = 'site/landing';

$route['all_listing'] = 'site/product/all_listing/$1';

$route['explore_listing'] = 'site/product/explore_listing';

$route['explore_listing/(:any)'] = 'site/product/explore_listing/$1';
...
$route['account-trans/(:any)/(:any)'] = "site/cms/dashboard_account_trans/$1/$2";
$route['account-trans/(:any)/(:any)/(:any)'] = "site/cms/dashboard_account_trans/$1/$2/$3";

$route['account-trans-future'] = "site/cms/dashboard_account_trans_future";

$route['account-trans-future/(:any)'] = "site/cms/dashboard_account_trans_future/$1";

$route['account-trans-future/(:any)/(:any)/(:any)'] = "site/cms/dashboard_account_trans_future/$1/$2/$3";
...
$route['msg-starred'] = "site/cms/msg_starred";

$route['msg-starred/(:any)'] = "site/cms/msg_starred/$1";

$route['change-star-status/(:any)/(:any)/(:any)'] = "site/cms/change_star_status/$1";

$route['change-archive-status/(:any)/(:any)/(:any)'] = "site/cms/change_archive_status/$1";

$route['msg-unread'] = "site/cms/msg_unread";

$route['msg-unread/(:any)'] = "site/cms/msg_unread/$1";

$route['msg-archived'] = "site/cms/msg_archived";

$route['msg-archived/(:any)'] = "site/cms/msg_archived/$1";

$route['msg-pending-request'] = "site/cms/msg_pending_request";

$route['msg-pending-request/(:any)'] = "site/cms/msg_pending_request/$1";

$route['msg-reservation'] = "site/cms/msg_reservation";

$route['msg-reservation/(:any)'] = "site/cms/msg_reservation/$1";
...
$route['c/invite/(:any)/(:any)'] = "site/cms/dashboard_invite_login";
...
$route['display-dispute-filter/(:any)'] = "site/product/display_dispute_filter/$1";

$route['display-dispute1-filter/(:any)'] = "site/product/display_dispute1_filter/$1";

//end of dispute filter

$route['host_cancelled_bookings'] = "site/product/cancel_by_host";

$route['host_cancelled_bookings_experience'] = "site/experience/cancel_by_host";

$route['host_cancelled_bookings_experience/(:any)'] = "site/experience/cancel_by_host/$1";
...
$route['basic_info/(:any)'] = "site/product/basic_info/$1";

$route['address_listing/(:any)'] = "site/product/address_listing/$1";

$route['cancel_policy/(:any)'] = "site/product/cancel_policy/$1";

$route['insert_cancel_policy/(:any)'] = "site/product/insert_cancel_policy/$1";

$route['detail_list/(:any)'] = "site/product/detail_list/$1";

/* Exprience module */

$route['explore-experience'] = "site/experience/explore_experience";

$route['explore-experience/(:any)'] = "site/experience/explore_experience/$1";
...
$route['experience-transactions/(:any)/(:any)'] = "site/experience/dashboard_account_trans/$1/$2";
...
$route['experience-msg-starred'] = "site/experience/msg_starred";

$route['experience-msg-starred/(:any)'] = "site/experience/msg_starred/$1";

$route['experience-change-star-status/(:any)/(:any)/(:any)'] = "site/experience/change_star_status/$1";

$route['experience-change-archive-status/(:any)/(:any)/(:any)'] = "site/experience/change_archive_status/$1";

$route['experience-msg-unread'] = "site/experience/msg_unread";

$route['experience-msg-unread/(:any)'] = "site/experience/msg_unread/$1";

$route['experience-msg-archived'] = "site/experience/msg_archived";

$route['experience-msg-archived/(:any)'] = "site/experience/msg_archived/$1";

$route['experience-msg-pending-request'] = "site/experience/msg_pending_request";

$route['experience-msg-reservation'] = "site/experience/msg_reservation";

$route['experience-msg-reservation/(:any)'] = "site/experience/msg_reservation/$1";
...
$route['json/mobile_host_instant_pay'] = "site/mobile/mobile_host_instant_pay";
...
$route['json/remove_wishlist_experience'] = "site/mobile/mobile_remove_wishlist_experience";
$route['json/experience_paypal_success'] = "site/mobilecart/experience_paypal_success";
$route['json/experience_pay_by_stripe'] = "site/mobilecart/UserExperiencePaymentCreditStripe";
$route['json/experience_pay_by_credit_card'] = "site/mobilecart/ExperiencePaymentCredit";

$route['json/manage_experience'] = "site/mobile/manage_experience";
$route['json/add_experience_basic'] = "site/mobile/add_new_experience"; 
$route['json/add_experience_language'] = "site/mobile/add_experience_language"; 
$route['json/add_organization_dtls'] = "site/mobile/add_organization_dtls";
$route['json/add_experience_title'] = "site/mobile/add_experience_title"; 
$route['json/add_experience_schedule'] = "site/mobile/add_experience_schedule";
$route['json/add_experience_timesheet'] = "site/mobile/add_experience_timesheet";
$route['json/view_experience_timesheet'] = "site/mobile/view_experience_timesheet";
$route['json/edit_experience_timesheet'] = "site/mobile/edit_experience_timesheet";
$route['json/update_experience_timesheet'] = "site/mobile/update_experience_timesheet";
$route['json/delete_experience_timesheet'] = "site/mobile/delete_experience_timesheet";
$route['json/change_exp_timesheet_status'] = "site/mobile/change_exp_timesheet_status";
$route['json/delete_experience_schedule'] = "site/mobile/delete_experience_schedule";
$route['json/change_exp_date_status'] = "site/mobile/change_exp_date_status";
$route['json/add_experience_tagline'] = "site/mobile/add_experience_tagline";
$route['json/add_experience_photos'] = "site/mobile/add_experience_photos";
$route['json/delete_experience_photos'] = "site/mobile/delete_experience_photos"; 
$route['json/add_what_you_will_do'] = "site/mobile/add_what_you_will_do";
$route['json/add_where_you_will_be'] = "site/mobile/add_where_you_will_be";
$route['json/add_location_details'] = "site/mobile/add_location_details";
$route['json/add_kit_details'] = "site/mobile/add_kit_details";
$route['json/edit_kit_details'] = "site/mobile/edit_kit_details";
$route['json/update_kit_details'] = "site/mobile/update_kit_details";
$route['json/delete_kit_details'] = "site/mobile/delete_kit_details";
$route['json/add_notes_to_guest'] = "site/mobile/add_notes_to_guest";
$route['json/add_host_details'] = "site/mobile/add_host_details";
$route['json/add_guest_requirements'] = "site/mobile/add_guest_requirements";
$route['json/add_group_size'] = "site/mobile/add_group_size";
$route['json/add_price'] = "site/mobile/add_price";
$route['json/add_experience_cancel_policy'] = "site/mobile/add_experience_cancel_policy";

$route['json/experience_history'] = "site/mobile/experience_history";
$route['json/add_exp_review'] = "site/mobile/mobile_add_exp_review";
$route['json/add_exp_cancellation'] = "site/mobile/mobile_add_exp_cancellation";
$route['json/view_your_exp_review'] = "site/mobile/view_your_exp_review";
$route['json/view_your_exp_cancellation'] = "site/mobile/view_your_exp_cancellation";
$route['json/send_exp_message'] = "site/mobile/send_exp_message";
$route['json/mobile_experiencelistview'] = "site/mobile/experience_listview";
$route['json/experience_booking_enquiry'] = "site/mobile/experience_booking_enquiry";
$route['json/experience_booking_confirm'] = "site/mobile/experience_booking_confirm";
$route['json/experience_guest_pay_stripe'] = "site/mobile/experience_guest_pay_stripe";
$route['json/experience_guest_pay_creditcard'] = "site/mobile/experience_guest_pay_creditcard";
$route['json/experience_guest_pay_paypal'] = "site/mobile/experience_guest_pay_paypal";
$route['json/experience_host_pay_stripe'] = "site/mobile/experience_host_pay_stripe";
$route['json/experience_host_pay_paypal'] = "site/mobile/experience_host_pay_paypal";
$route['json/payment_gateway_status'] = "site/mobile/payment_gateway_status";
$route['json/invoice'] = "site/mobile/invoice";

/*Muppidathi P - FOR CANCELLATION, COUPON, WALLET, DISPUTE AND INBOX */
$route['json/add_property_cancel'] = "site/mobile/mobile_property_cancel";/*USER CANCEL*/
$route['json/host_accept_cancel_request'] = "site/mobile/host_accept_cancel_request";
$route['json/host_reject_cancel_request'] = "site/mobile/host_reject_cancel_request";
$route['json/property_cancel_view'] = "site/mobile/mobile_property_cancel_view";
$route['json/mobile_host_cancel_booking'] = "site/mobile/mobile_host_cancel_booking";/*HOST CANCEL*/
$route['json/mobile_get_host_cancellation'] = "site/mobile/mobile_get_host_cancellation";/*HOST CANCELLATION DETAILS*/

/*COUPON START*/
$route['json/mobile_coupon_details'] = "site/mobile/get_coupon_details";
$route['json/mobile_coupon_code_apply'] = "site/mobile/mobile_coupon_code_apply";
$route['json/mobile_coupon_code_reject'] = "site/mobile/mobile_coupon_code_reject";

/*WALLET START*/
$route['json/mobile_overall_wallet'] = "site/mobile/mobile_overall_wallet";
$route['json/mobile_wallet_apply'] = "site/mobile/mobile_wallet_apply";

/*DISPUTE STATUS CHANGE*/
$route['json/mobile_dispute_status_change'] = "site/mobile/mobile_dispute_status_change";

/*INBOX */
$route['json/mobile_inbox_starred_message'] = "site/mobile/mobile_inbox_starred_message";
$route['json/mobile_inbox_unread_message'] = "site/mobile/mobile_inbox_unread_message";
$route['json/mobile_inbox_reservation_message'] = "site/mobile/mobile_inbox_reservation_message";
$route['json/mobile_inbox_pending_req_message'] = "site/mobile/mobile_inbox_pending_req_message";
$route['json/mobile_inbox_archived_message'] = "site/mobile/mobile_inbox_archived_message";
$route['json/mobile_inbox_star_status'] = "site/mobile/mobile_inbox_star_status";
$route['json/mobile_inbox_archive_status'] = "site/mobile/mobile_inbox_archive_status";

/*******Muppidathi P - End API*************/

/**********************************/

$route['facebooklogin'] = "site/landing/facebooklogin";
$route['ajax_autocomplete_name'] = "admin/reports/autocomplete_name";
$route['ajax_autocomplete_name_exp'] = "admin/reports/ajax_autocomplete_name_exp";
$route['ajax_autocomplete_name_guest'] = "admin/reports/ajax_autocomplete_name_guest";
$route['ajax_autocomplete_name_host'] = "admin/reports/ajax_autocomplete_name_host";
/**********************************/
//bulk_user_add
$route['add_bulk_users'] = "site/bulk/add_bulk_users";
$route['add_bulk_products'] = "site/bulk/add_bulk_products";
$route['add_bulk_experiance'] = "site/bulk/add_bulk_experiance";
$route['add_bulk_products_book'] = "site/bulk/add_bulk_products_book";
$route['add_bulk_experience_book'] = "site/bulk/add_bulk_experience_book";
