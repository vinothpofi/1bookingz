...
(function($){
  ...
  /*custom calendar gangatharan*/

	var cal_avail_count='';

	var cal_booked_count='';

	var cal_unavail_count='';
 ...
 /*custom calendar gangatharan*/
    ...
    $.fn.DOPBackendBookingCalendarPRO = function(options){
        ...
        var Data = {'AddtMonthViewText': 'Add Month View', // Add Month View button title (plus icon).
                    ...
                    'FirstDay': 7, // Set the first day of the week (1 = Monday, 2 = Tuesday, 3 = Wednesday, 4 = Thursday, 5 = Friday, 6 = Saturday, 7 = Sunday)
        ...
        methods = {            
                    ...
                    initNavigation:function(){// Init Navigation
                        ...
                        $('.DOPBackendBookingCalendarPRO_Navigation .previous_btn', Container).bind('click', function(){                                                            
                            ...
                            if (CurrMonth == StartMonth){
								...
								$('.calender-left-arrow').css('cursor','default');
                        ...
                        $('.DOPBackendBookingCalendarPRO_Navigation .next_btn', Container).bind('click', function(){
							...
							$('.calender-left-arrow').css('cursor','pointer');

							$('.calender-left-arrow').css('opacity',1);
						...
						/*custom work for calendar*/

						 $('#get_calendar').on('change', function(){
	                    ...
	                    year_month=year_month.split('-');
                            ...
                            methods.generateCalendar(year_month[0], year_month[1]);
						 ...
						 $('.calender-left-arrow').unbind('click');

                        $('.calender-left-arrow').bind('click', function(){                                                            
						...
						$('.calender-right-arrow').unbind('click');

						 $('.calender-right-arrow').bind('click', function(){
                    ...
                    generateCalendar:function(year, month){// Init Calendar       
                        ...
                        $('#selected_month_year').html(MonthNames[(CurrMonth%12 != 0 ? CurrMonth%12:12)-1]+' '+CurrYear);						
                    ...
                    initMonth:function(year, month, position){// Init Month
                        ...
                        if (position > 1){
							...
							$('#selected_month_year').html(MonthNames[(month%12 != 0 ? month%12:12)-1]+' '+year);
                    ...
                    initDay:function(type, id, day, available, bind, info, notes, price, promo, status){// Init Day
                        ...
                        if (price > 0 && (bind == 0 || bind == 1)){
                            ...
                            contentLine1 = Math.round(price)+Currency;
						...
						var cal_custom_class='avail-first';

						cal_avail_count=day;

						}

						else if(cal_avail_count = day)

						{

						var cal_custom_class='avail-middle';
						...
						cal_avail_count=day;
                         ...
                         dayHTML.push('    <div class="bind-content group'+bind+' '+cal_custom_class+'">');
						...
						var cal_booked_class='booked-first';

						cal_booked_count=day;

						}

						else if(cal_booked_count = day)

						{

						var cal_booked_class='booked-middle';
						...
						cal_booked_count=day;
                         ...
                         dayHTML.push('    <div class="bind-content group'+bind+' '+cal_booked_class+'">');
...

						{
                         ...
                         if(cal_unavail_count=='')

						{

						var cal_unavail_class='unavail-first';

						cal_unavail_count=day;

						}

						else if(cal_unavail_count = day)

						{

						var cal_unavail_class='unavail-middle';
						...
						cal_unavail_count=day;
                         ...
                         dayHTML.push('    <div class="bind-content group'+bind+' '+cal_unavail_class+'">');
                        ...
                        if (promo > 0 && (bind == 0 || bind == 1)){
                            ...
                            dayHTML.push('            <div class="old-price">'+Math.round(price)+Currency+'</div>');
                        ...
                        dayHTML.push('            <div class="available">&nbsp;</div>');
                                    ...
                                    if (!day.hasClass('mask')){
                                        ...
                                        if (!day.hasClass('past_day')){
                                            ...
                                            if (!dayFirstSelected){
												...
												var h_cls = $('.DOPBackendBookingCalendarPRO_Month .selected').hasClass( "booked" );

												var h_cls_l = $('.DOPBackendBookingCalendarPRO_Month .selected').length;

												var h_cls_B = $('.DOPBackendBookingCalendarPRO_Day.booked.selected').length;//same div

												//alert(h_cls);

												//alert(h_cls_l+'selected length');

												//alert(h_cls_B+'booked length');

												//return false;

												

												if(h_cls==true && (h_cls_l!=h_cls_B)){	

													alert('In selected dates , booked date also there. Not allowed to Edit');
                    ...
                    showForm:function(){// Show Form
                        ...
                        HTML.push('                <input type="text" name="DOPBCP_price" id="DOPBCP_price" value="'+Math.round(bookprice)+'" /><span class="currency">'+currency+'</span>');

                        HTML.push('                <br class="DOPBackendBookingCalendarPRO_Clear" />');

                        HTML.push('            </div><input type="hidden" name="DOPBCP_promo" id="DOPBCP_promo" value="" disabled="disabled" /><input type="hidden" name="DOPBCP_available" id="DOPBCP_available" value="1" /><input type="hidden" name="DOPBCP_info" id="DOPBCP_info" value="" /><input type="hidden" name="DOPBCP_notes" id="DOPBCP_notes" value="" /><input type="hidden" name="DOPBCP_group" id="DOPBCP_group" value="" />');                        
