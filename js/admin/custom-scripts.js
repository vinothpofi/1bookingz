$(function() {
  ...
  validate:       true
	...
	========================*/
		...
		$('.user_renter :checkbox').iphoneStyle({ checkedLabel: 'User', uncheckedLabel: 'Renter' });
		...
		$('.verified_unverified :checkbox').iphoneStyle({ checkedLabel: 'Verified', uncheckedLabel: 'UnVerified' });
...
"sPaginationType": "full_numbers",
 ...
 $('#propertyCancel_tbl').dataTable({   
	...
	$('#location_tbl').dataTable({   
		...
		$('#subscribers_newsletter_tbl').dataTable({   
	...
	$('#dispute_tbl_property').dataTable({   
