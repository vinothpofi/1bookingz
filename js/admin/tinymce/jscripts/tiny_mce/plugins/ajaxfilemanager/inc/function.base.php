 ...
 * @return array()
 */
function getThumbWidthHeight( $originaleImageWidth, $originalImageHeight, $imageWidth, $imageHeight)
{
	...
	if(!empty($originaleImageWidth) && !empty($originalImageHeight))
	{
		...
		if(($imageWidth < 1 && $imageHeight < 1) || ($imageWidth > $originaleImageWidth && $imageHeight > $originalImageHeight ))
		{
