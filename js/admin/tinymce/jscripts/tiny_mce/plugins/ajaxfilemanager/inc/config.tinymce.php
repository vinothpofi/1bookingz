...
define('CONFIG_SYS_image_VIEW_ENABLE', true);//REMOVE THE image view if false
...
//Preview
define('CONFIG_IMG_image_MAX_X', 100);
define('CONFIG_IMG_image_MAX_Y', 100);
...
define('CONFIG_DEFAULT_VIEW', (CONFIG_SYS_image_VIEW_ENABLE?'detail':'detail')); //thumnail or detail
